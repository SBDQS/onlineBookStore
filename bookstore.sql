...
insert  into `customerdetailinfo`(`custId`,`tel`,`address`,`sex`,`age`,`countMoney`,`qq`) values (1,'13545698425','玉祥门',0,21,'126','766528@qq.com'),(2,'15885695429','明德门',1,18,'6','8885328@qq.com'),(3,'15845698425','长安路',1,22,'1226','766528@qq.com'),(4,'15999668489','大雁塔',0,23,'26','766528@qq.com'),(5,'13645655423','马路',0,20,NULL,'766528@qq.com'),(6,'13545698425','玉祥门',0,21,'126','766528@qq.com'),(7,'15885695429','明德门',1,18,'6','8885328@qq.com'),(8,'15845698425','长安路',1,22,'1226','766528@qq.com'),(9,'15999668489','大雁塔',0,23,'26','766528@qq.com'),(10,'13645655423','马路',0,20,NULL,'766528@qq.com');
...
insert  into `customerinfo`(`custId`,`custName`,`pwd`,`email`) values (1,'sss','123456','xiaohong@qq.com'),(2,'ccc','123456','xiaocheng@163.com'),(3,'hhh','123456','xiaohuang@yahu.com'),(4,'lll','123456','xiaolv@qq.com'),(5,'bbb','123456','xiaolan@qq.com'),(6,'123','66666','meimei@qq.com');
...
insert  into `employee`(`empId`,`empName`,`empAge`,`empBtd`,`empSex`,`isDelete`) values (1,'强哥',22,'1990-09-09',1,1),(2,'超人',30,'1980-09-09',1,1),(3,'梅林',40,'1970-09-09',1,1),(4,'东方',35,'1985-09-09',1,1);
...
insert  into `favorite`(`favoriteId`,`bookId`,`custId`,`scdate`,`context`) values (1,16,1,'2012-03-01','想买的书'),(2,10,3,'2007-02-03','很喜欢的书'),(3,7,2,'2012-04-27','期待的书'),(4,6,4,'2002-07-01','小说类的书'),(5,11,3,'2010-03-01','文学的书');
...
CREATE TABLE `ordermain` (
  ...
  `xsstatus` varchar(1) DEFAULT NULL,
